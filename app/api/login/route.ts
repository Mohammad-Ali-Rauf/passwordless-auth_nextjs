...
export async function POST(req: Request) {
	...
	try {
		transporter.sendMail({
			from: '"Ali Enterprises " <m.aliadnanrauf@gmail.com>',
			to: email,
            replyTo: 'Ali Enterprises',
            ...
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              ...
              <p style="text-align: center; margin: 20px 0;"><a href="${verificationUrl}" style="display: inline-block; padding: 12px 20px; background-color: #007BFF; color: #fff; text-decoration: none; border-radius: 5px;">Verify Email</a></p>
